...
typedef void(^Tao800BannerTapCallBack)(int bannerIndex, int bannerId); //第一个参数是点击的banner的顺序，第二个参数是bannerId

@interface Tao800BannerView : TBUICycleScrollView <TBUICycleScrollViewDataSource,
...
@property (nonatomic, copy) Tao800BannerTapCallBack userDidClickOneItem;
