...
- (NSString *)encryptString:(NSString *)stringToEncrypt{
	...
	NSUInteger iStringLength = [stringToEncrypt length]; // declare a variable to take the length of the incoming string
	unsigned char k;
	unsigned char t;
...
- (NSString *)decryptString:(NSString *)stringToDecrypt{
	...
	//TODO: Extra Credit: implement this function to decrypt stringToDecrypt using the Tao800RC4 algorithm.
	return @"";
}
