...
- (NSArray *)elementsForLocalName:(NSString *)localName URI:(NSString *)uri
{
	...
	NSString *prefix1 = [self _recursiveResolvePrefixForURI:uri atNode:(xmlNodePtr)genericPtr];
	if (prefix1)
	{
		NSString *name = [NSString stringWithFormat:@"%@:%@", prefix1, localName];
		
		return [self _elementsForName:name localName:localName prefix:prefix1 uri:uri];
	}
	else
	{
		NSString *prefix;
